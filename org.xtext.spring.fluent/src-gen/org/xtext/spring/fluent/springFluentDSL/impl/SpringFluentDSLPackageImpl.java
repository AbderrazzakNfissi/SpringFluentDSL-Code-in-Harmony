...
public class SpringFluentDSLPackageImpl extends EPackageImpl implements SpringFluentDSLPackage
{
  ...
  public void initializePackageContents()
  {
    ...
    addEEnumLiteral(dependencyTypeEEnum, DependencyType.SPRING_KAFKA);
    addEEnumLiteral(dependencyTypeEEnum, DependencyType.SPRING_INTEGRATION_WS);
    addEEnumLiteral(dependencyTypeEEnum, DependencyType.SPRING_INTEGRATION_WEB_FLUX);
    addEEnumLiteral(dependencyTypeEEnum, DependencyType.SPRING_INTEGRATION_SECURITY);
    addEEnumLiteral(dependencyTypeEEnum, DependencyType.SPRING_INTEGRATION_REDIS);
    addEEnumLiteral(dependencyTypeEEnum, DependencyType.SPRING_INTEGRATION_MONGO_DB);
    addEEnumLiteral(dependencyTypeEEnum, DependencyType.SPRING_INTEGRATION_KAFKA);
    addEEnumLiteral(dependencyTypeEEnum, DependencyType.SPRING_INTEGRATION_JPA);
    addEEnumLiteral(dependencyTypeEEnum, DependencyType.SPRING_INTEGRATION_JDBC);
    addEEnumLiteral(dependencyTypeEEnum, DependencyType.SPRING_INTEGRATION_HTTP);
    addEEnumLiteral(dependencyTypeEEnum, DependencyType.SPRING_INTEGRATION_AMQP);
    addEEnumLiteral(dependencyTypeEEnum, DependencyType.SPRING_WEB_FLUX);
    addEEnumLiteral(dependencyTypeEEnum, DependencyType.SPRING_WEB_SERVICES);
    addEEnumLiteral(dependencyTypeEEnum, DependencyType.SPRING_VALIDATION);
    addEEnumLiteral(dependencyTypeEEnum, DependencyType.SPRING_THYMELEAF);
    addEEnumLiteral(dependencyTypeEEnum, DependencyType.SPRING_OAUTH2_CLIENT);
    addEEnumLiteral(dependencyTypeEEnum, DependencyType.SPRING_JERSEY);
    addEEnumLiteral(dependencyTypeEEnum, DependencyType.SPRING_JDBC);
    addEEnumLiteral(dependencyTypeEEnum, DependencyType.SPRING_INTEGRATION);
    addEEnumLiteral(dependencyTypeEEnum, DependencyType.SPRING_DATA_REST);
    addEEnumLiteral(dependencyTypeEEnum, DependencyType.SPRING_GRAPH_QL);
    addEEnumLiteral(dependencyTypeEEnum, DependencyType.SPRING_DATA_ELASTICSEARCH);
    addEEnumLiteral(dependencyTypeEEnum, DependencyType.SPRING_DATA_JDBC);
    addEEnumLiteral(dependencyTypeEEnum, DependencyType.SPRING_DATA_MONGO_DB);
    ...
    addEEnumLiteral(dependencyTypeEEnum, DependencyType.SPRING_ACTUATOR);
    addEEnumLiteral(dependencyTypeEEnum, DependencyType.SPRING_GRAPH_QL_TEST);
